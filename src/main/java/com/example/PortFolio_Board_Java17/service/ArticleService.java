...
public class ArticleService {
    ...
    public void saveArticle(ArticleDto dto) {articleRepository.save(dto.toEntity());
    }
    ...
    public void deleteArticle(long articleId) {articleRepository.deleteById(articleId);
    }
